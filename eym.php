...
<html>
<head>
	<title>Electricidad y Magnetismo</title>          			<!-- Titulo de la pestaña uwu -->
...
<body>
	...
	<main>
		...
		<div class="contenido">
			<h3 class="bloque"><a href="circuitos.php">Electricidad y Magnetismo</a></h3>
			<br>
			...
			<table>
				...
				<?php 
					$sql="SELECT * FROM datasheets
						  WHERE 
						  (
						   Materia LIKE '%Electricidad y Magnetismo%'
						  ) ORDER BY ID ASC;";
