...
<html>
<head>
	<title>Electronica Analogica</title>          			<!-- Titulo de la pestaña uwu -->
...
<body>
	...
	<main>
		...
		<div class="contenido">
			<h3 class="bloque"><a href="analog.php.php">Electronica Analogica</a></h3>
			<br>
			...
			<table>
				...
				<?php 
					$sql="SELECT * FROM datasheets
						  WHERE 
						  (
						   Materia LIKE '%Electronica Analogica%'
						  ) ORDER BY ID ASC;";
