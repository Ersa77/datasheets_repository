...
<html>
<head>
	<title>Circuitos de Radiofrecuencia</title>          			<!-- Titulo de la pestaña uwu -->
...
<body>
	...
	<main>
		...
		<div class="contenido">
			<h3 class="bloque"><a href="circuitos.php">Circuitos de Radiofrecuencia</a></h3>
			<br>
			...
			<table>
				...
				<?php 
					$sql="SELECT * FROM datasheets
						  WHERE 
						  (
						   Materia LIKE '%Circuitos de Radiofrecuencia%'
						  ) ORDER BY ID ASC;";
