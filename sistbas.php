...
<html>
<head>
	<title>Sistemas Basicos, Arquitectura y Procesamiento</title>          			<!-- Titulo de la pestaña uwu -->
...
<body>
	...
	<main>
		...
		<div class="contenido">
			<h3 class="bloque"><a href="circuitos.php">Sistemas Basicos, Arquitectura y Procesamiento</a></h3>
			<br>
			...
			<table>
				...
				<?php 
					$sql="SELECT * FROM datasheets
						  WHERE 
						  (
						   Materia LIKE '%Sistemas Basicos, A y P%'
						  ) ORDER BY ID ASC;";
