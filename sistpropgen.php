...
<html>
<head>
	<title>Sistemas de Proposito General</title>          			<!-- Titulo de la pestaña uwu -->
...
<body>
	...
	<main>
		...
		<div class="contenido">
			<h3 class="bloque"><a href="circuitos.php">Sistemas de Proposito General</a></h3>
			<br>
			...
			<table>
				...
				<?php 
					$sql="SELECT * FROM datasheets
						  WHERE 
						  (
						   Materia LIKE '%Sistemas de Proposito General%'
						  ) ORDER BY ID ASC;";
