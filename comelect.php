...
<html>
<head>
	<title>Comunicaciones Electronicas</title>          			<!-- Titulo de la pestaña uwu -->
...
<body>
	...
	<main>
		...
		<div class="contenido">
			<h3 class="bloque"><a href="circuitos.php">Comunicaciones Electronicas</a></h3>
			<br>
			...
			<table>
				...
				<?php 
					$sql="SELECT * FROM datasheets
						  WHERE 
						  (
						   Materia LIKE '%Comunicaciones Electronicas%'
						  ) ORDER BY ID ASC;";
