...
<html>
<head>
	<title>Sistemas de Modulacion</title>          			<!-- Titulo de la pestaña uwu -->
...
<body>
	...
	<main>
		...
		<div class="contenido">
			<h3 class="bloque"><a href="circuitos.php">Sistemas de Modulacion</a></h3>
			<br>
			...
			<table>
				...
				<?php 
					$sql="SELECT * FROM datasheets
						  WHERE 
						  (
						   Materia LIKE '%Sistemas de Modulacion%'
						  ) ORDER BY ID ASC;";
